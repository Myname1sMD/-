...
const universityData = [
    ...
    {
        // КарНИУ (КарНИУ им. Е. А. Букетова) - Карагандинский университет им. Е. А. Букетова (бывш. КарГУ)
        "id": "karu",
        "name": "Карагандинский национальный исследователський университет им. Е. А. Букетова (КарУ)",
        "city": "Караганда",
    ...
    },
    {
        ...
        "sections": {
            ...
            "admission": {
                "title": "📝 Прием и Поступление",
                "requirements": "ЕНТ, профильные предметы – Математика и Физика, Информатика.",
                "deadlines": "Прием заявлений: Июль – Август.",
